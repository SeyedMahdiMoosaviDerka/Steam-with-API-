function showModal(pid) {
  ...
  setTimeout(() => {
      ...
      searchingBackground.style.position = "absolute";
  }, 500);
  ...
  AddWishListBT.setAttribute("data-id", curEL.numberOfgame);
    ...
    Modal_BigPic.src = "Content/Media/Store_recommended/gallery/" + curEL.GameImages[1];
    Modal_Pic1.src = "Content/Media/Store_recommended/gallery/" + curEL.GameImages[1];
    Modal_Pic2.src = "Content/Media/Store_recommended/gallery/" + curEL.GameImages[2];
    Modal_Pic3.src = "Content/Media/Store_recommended/gallery/" + curEL.GameImages[3];
    Modal_Pic4.src = "Content/Media/Store_recommended/gallery/" + curEL.GameImages[0];

    onvanPic.src = "Content/Media/Store_recommended/gallery/" + curEL.GameImages[0];
...
function CloseModalFunction() {
  searchingBackground.style.position = "relative";
  ...
  searchingBackground.style.visibility = "visible";
