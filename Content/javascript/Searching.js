...
function Going_StoreSection() {
  ...
  StoreMenuBackgroundVideo.src = "../Content/Media/StoreMenu/webm_page_bg_english.mp4";
...
/* Right Sorting onclick: */

NarroPriceSection.style.height = "220px";
NarroPriceSectionOpened = true;

NarroTagSection.style.height = "30px";
NarroTagSectionOpened = false;

NarroOSSection.style.height = "150px";
