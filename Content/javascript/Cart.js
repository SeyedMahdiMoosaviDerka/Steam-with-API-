...
function OpenCart() {
    ...
    for (i = 0; i < bas.length; i++) {
        ...
        img.src = "../Content/Media/Store_recommended/gallery/" + bas[i].elPic;
...
function OpenCartAnim() {
    ...
    /* showing Cart detail with opacity: */
    ShowPrice_Cart.style.opacity = "0";
    ShowingGridCart.style.opacity = "0";
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            /* showing Cart detail with opacity: */
                            ShowPrice_Cart.style.opacity = "1";
                            ShowingGridCart.style.opacity = "1";
                        }, 500);
                    }, 300);
                }, 300);
